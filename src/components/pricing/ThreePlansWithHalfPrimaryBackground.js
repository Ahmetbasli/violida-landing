...
export default ({
  subheading = "",
  heading = "Violdida nın maliyeti ne kadardır?",
  description = "Bugün ücretsiz denemeye başla. Her büyüklükteki işletme için planlarımız mevcut. Kredi kartı gerekmez.",
  plans = null,
  ...
  const defaultPlans = [
    {
      ...
      features: [
        ...
        "Whatsapp, Instagram, Konum yönlendirme",
        "İşletme Logosu ve Bilgileri",
        "Firmaya Özgün Renk Seçeneği",
      ],
