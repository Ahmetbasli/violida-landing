...
export default ({
  subheading = "",
  heading = "What does Violida cost?",
  description = "Start your free trial today. We have plans for businesses of all sizes. No credit card required.",
  plans = null,
  ...
  const defaultPlans = [
    {
      ...
      features: [
        ...
        "WhatsApp, Instagram, Location Redirection",
        "Business Logo and Information",
        "Company-Specific Color Option",
      ],
